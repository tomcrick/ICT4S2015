...
\begin{IEEEkeywords}
ICT, Life Cycle Assessment, Environmental Impact, Low Carbon Society, Emissions, Energy
\end{IEEEkeywords}


\section{Introduction}

\subsection{ICT in Modern Society}
...
3.9\% of global energy use~\cite{plepys:2002,wheeland:2011}. While
...
the manufacture stage. Technology manufacturers such as Apple publish
...
Williams et al. analyses the potential reductions in GHG production
through a shift to cloud computing~\cite{williams-et-al:2014}, and the
rebound effect of digital data becoming cheaper and easier to consume
meaning more and more is used is well documented. There is a strong
commercial motivation for such users, with the potential to save
high-intensity ICT organisations substantial savings from switching to
the cloud.
...
Administration\footnote{\url{www.eia.gov/cfapps/ipdbproject/}}. Primary
research in this area is ultimately constrained by cost; by
...
However, if the highest device energy users -- the Intense Clouders
and Intense Non-Clouders -- have any flexibility as to when they are
able to undertake their high power processing, careful monitoring of
the live carbon value could result in as much as a 45\% reduction in
its carbon if done at a low point rather than a high point. These user
types also have the highest proportion of device energy. That is to
say, those with high energy use over a year typically pay a larger
share of that (on the assumption WAN and Servers are not paid for by
the user directly). As such, if carbon-based taxing or demand-based
pricing, as has been suggested, becomes a reality, this time
consideration will make economic as well as environmental sense.
...
but if successful would be extremely effective.
