...
behaviour affects this impact. By using a life cycle assessment
process, we are able to estimate the environmental impact of the IT
...
usage (and thus CO$_2$ produced) of each stage in the data chain,
summed to a CO$_2$ value for embodied carbon of an average device. To
enable this, market segmentation is undertaken to determine the
average user and average use, along with market research to determine
the average device. Analysis of device performance in difference
behaviours is also undertaken.
